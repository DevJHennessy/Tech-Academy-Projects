    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                /* A way around not being able to skip optional parameters
               
                performAttack(heroHealth, 20, "Monster", "Hero", defenderArmorBonus: 10);
                */

                /* You can also name each parameter in any order you want 
                 * (this is called passing named arguments into parameters):
