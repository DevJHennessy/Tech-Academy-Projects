...
namespace CS_ASP_034
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                if (defeatEnemy(heroHealth, 20, "Monster", "Hero", out heroHealth))
                    lootEnemy();
                else if (defeatEnemy(monsterHealth, 20, "Hero", "Monster", out monsterHealth))
                    lootEnemy();
        ...
        private bool defeatEnemy(int defeanderHealth,
            ...
            out int remainingDefenderHealth)
        {
            ...
            remainingDefenderHealth = defeanderHealth - damage;
