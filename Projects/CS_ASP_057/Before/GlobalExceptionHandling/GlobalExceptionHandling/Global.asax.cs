...
namespace GlobalExceptionHandling
{
    public class Global : System.Web.HttpApplication
    {
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            //You can also implement a global except handler here by adding the following:
            void Application_Error(object sender, EventArgs e)
        {

            //This is where you write code that is fired off a higher level, at the
            //application level.
            ...
            //TODO: you might want to implement logging here.

            //You must do this if you want to hide the yellow page of death. Any
            //existing existing exceptions after this point will send the end user the
            //exception page.
            Server.ClearError();
        }
