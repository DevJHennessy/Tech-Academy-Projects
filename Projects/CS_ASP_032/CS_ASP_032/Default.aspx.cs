    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                //Cannot skip optional parameters, except for the last one:
                //This does not work: monsterHealth = performAttack(monsterHealth, 20, "Hero", "Monster",, 10);
        ...
        private int performAttack(
            ...
            //Optional parameter declarations have to made at the end,
            //cannot be made at beginning or middle.
        {
